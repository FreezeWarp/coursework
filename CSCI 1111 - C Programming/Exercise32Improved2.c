 ...
 * Anyway, add six lines of code and user input will work. Commented it out to meet assignment specifications, but it's there to prove a point -- this is capable of doing user input with no modification.
 */
...
int main(int argc, char *argv[ ])
{
  ...
  int (***ar) = malloc(sizeof(int) * ROWS * COLUMNS * THREEDDD);
