...
import edu.metrostate.ics425.product.Product;
import java.util.Objects;

/**
 * Represents a Product based on the Product interface; that is, having a code, description, price, and release date, and being able to calculate the years released.
